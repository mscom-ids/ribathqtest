...
// ── Main Component ────────────────────────────────────────────
export function StudentDetailView({ canEdit = true, backTo }: { canEdit?: boolean; backTo?: string } = {}) {
                ...
                <div className="flex-1 w-full min-w-0">
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <TabsContent value="admission" className="mt-0">
                            <AdmissionDetailsTab studentId={id} initialData={studentData?.comprehensive_details?.admission} canEdit={canEdit} />
                        </TabsContent>
                        ...
                        <TabsContent value="religious" className="mt-0">
                            <ReligiousEducationTab studentId={id} initialData={studentData?.comprehensive_details?.religious} canEdit={canEdit} />
                        </TabsContent>
                            ...
                            <TabsContent key={tab} value={tab} className="mt-0">
                                <Card className="shadow-sm border border-slate-200 dark:border-[#2a3348] bg-white dark:bg-[#1e2538]">
                                    <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 dark:border-[#2a3348]">
                                        ...
                                        {canEdit && <Button variant="outline" size="sm" className="text-xs">Update</Button>}
                                    </CardHeader>
                                    <CardContent className="p-6">
                                        <div className="text-center py-8 text-slate-400 bg-slate-50 dark:bg-slate-900/30 rounded-lg text-sm">
