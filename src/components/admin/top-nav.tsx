    ...
    return (
        <header suppressHydrationWarning className="fixed top-0 lg:left-[260px] left-0 right-0 z-30 h-[60px] bg-white dark:bg-[#1a1f2e] border-b border-[#e8ede9] dark:border-[#2a2f3e] flex items-center px-4 lg:px-6 gap-3 transition-colors">
            ...
            <div className="relative flex items-center flex-1 lg:flex-none">
                ...
                <input suppressHydrationWarning type="text" placeholder="Search..."
            ...
            <div className="flex items-center gap-3 ml-auto">
                <button suppressHydrationWarning className="hidden sm:flex h-9 w-9 rounded-xl bg-[#f7f9f7] dark:bg-[#232838] border border-[#e8ede9] dark:border-[#2a2f3e] items-center justify-center text-[#9ca3af] hover:text-[#1a3d2a] dark:hover:text-[#7de0a8] hover:bg-[#eaf4ee] dark:hover:bg-[#2a2f3e] transition-all shrink-0">
                    <Mail className="h-4 w-4" />
                </button>
                <button suppressHydrationWarning className="relative flex h-9 w-9 rounded-xl bg-[#f7f9f7] dark:bg-[#232838] border border-[#e8ede9] dark:border-[#2a2f3e] items-center justify-center text-[#9ca3af] hover:text-[#1a3d2a] dark:hover:text-[#7de0a8] hover:bg-[#eaf4ee] dark:hover:bg-[#2a2f3e] transition-all shrink-0">
