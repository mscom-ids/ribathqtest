...
router.get('/next-id', (0, auth_middleware_1.requireRole)(STUDENT_MANAGE_ROLES), students_helpers_1.getNextStudentId);
// GET /api/students/counts (Lightweight aggregation for the admin dashboard)
router.get('/counts', (0, auth_middleware_1.requireRole)(STUDENT_MANAGE_ROLES), students_controller_1.getStudentCounts);
// GET /api/students/staff (Helper)
router.get('/staff', (0, auth_middleware_1.requireRole)(STUDENT_MANAGE_ROLES), students_helpers_1.getStaff);
...
router.post('/', (0, auth_middleware_1.requireRole)(STUDENT_MANAGE_ROLES), students_controller_1.createStudent);
// PUT /api/students/:id (Only Admins/Principals)
router.put('/:id', (0, auth_middleware_1.requireRole)(STUDENT_MANAGE_ROLES), students_controller_1.updateStudent);
