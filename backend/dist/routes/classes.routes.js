...
router.get('/promotion/students', (0, auth_middleware_1.requireRole)(CLASS_MANAGE_ROLES), classes_controller_1.getPromotionStudents);
router.post('/promotion/execute', (0, auth_middleware_1.requireRole)(CLASS_MANAGE_ROLES), classes_controller_1.executePromotion);
router.get('/promotion-students', (0, auth_middleware_1.requireRole)(CLASS_MANAGE_ROLES), classes_controller_1.getPromotionStudents);
router.post('/execute-promotion', (0, auth_middleware_1.requireRole)(CLASS_MANAGE_ROLES), classes_controller_1.executePromotion);
router.post('/bulk-assign-hifz', (0, auth_middleware_1.requireRole)(['admin', 'principal', 'vice_principal']), classes_controller_1.bulkAssignHifzClass);
