...
router.post('/year-start/preview', requireRole(HISTORY_MANAGE_ROLES), previewYearStart);
router.post('/year-start/commit', requireRole(HISTORY_MANAGE_ROLES), commitYearStart);
